...
m6a_dir = "/data6/revised_version/data/total_m6a_peak/autosomal"
m6a_snp_dir = "/data6/revised_version/project/GTEx_analysis/intersect/condition"
con_dir = "/data6/revised_version/data/input_bed/autosomal/100cycle_input"
con_snp_dir = "/data6/revised_version/project/GTEx_analysis/intersect/control"
result_dir = "/data6/revised_version/project/GTEx_analysis/Fisher_exact_test"
if not os.path.exists(result_dir):
	os.makedirs(result_dir)
outfile = "%s%sFisher_m6a_vs_input.txt" % (result_dir, os.sep)
