...
def parameter_setting(case_type):
    ...
    if case_type == "ip":
        data_type = "SE"
        postfix = ".fastq.gz"
        fq_dir = "/data3/xs/original_data/GZRB2016083101970SSQ_custom/01.cleandata"
        bowtie2_result_dir = "/data5/galaxy/project/liver_map/map_result/01bowtie2_result"
        hisat2_result_dir = "/data5/galaxy/project/liver_map/map_result/02hisat2_result"
